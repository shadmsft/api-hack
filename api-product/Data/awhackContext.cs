...
namespace api_product.Data
{
    public partial class awhackContext : DbContext
    {
        public awhackContext()
        {
        }

        public awhackContext(DbContextOptions<awhackContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BuildVersion>(entity =>
            {
                entity.HasKey(e => e.SystemInformationId)
                    .HasName("PK__BuildVer__35E58ECA52544A11");
